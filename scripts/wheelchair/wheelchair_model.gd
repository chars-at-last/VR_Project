...
func rotate_wheels_const(mult_front: float = 1, mult_back_left: float = 1, mult_back_right: float = 1) -> void:
	rotate_wheels(MODEL_WHEEL_ROTATION_DEFAULT * mult_front, MODEL_WHEEL_ROTATION_DEFAULT * mult_back_left, MODEL_WHEEL_ROTATION_DEFAULT * mult_back_right)
